...
class PostController extends Controller {
    //exclusiones a metodo para autenticar usuario
    ...
    //Insertar un post que tiene ligado un usuario y una categoria 
        ...
        if (!empty($params_array)) {
            ...
            if ($validate->fails()) {
                $data = [
                    'code' => 404,
                    'status' => 'error',
                    'message' => 'Error al guardar el post, faltan datos'
                ];
            } else {
                //guardar el post 
                $post = new Post();
    ...
    public function update($id, Request $request) {
        ...
        if (!empty($params_array)) {
            ...
            //eliminar lo qu no queremos actualizar 
